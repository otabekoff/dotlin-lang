  ...
  std::vector<Token> tokenize(const std::string &src)
  {
    ...
    while (i < src.length())
    {
      ...
      else
      {
        ...
        // Defensive check: ensure we're not creating an EOF token with non-empty text
        ...
        // Additional check: if text is empty for tokens that should have text, mark as unknown
